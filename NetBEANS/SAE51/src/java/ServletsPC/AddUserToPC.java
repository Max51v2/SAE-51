 ...
 * @version 1.0
 */
@WebServlet(name = "AddUserToPC", urlPatterns = {"/AddUserToPC"})
public class AddUserToPC extends HttpServlet {

    /**
     * Ajoute les droits d'accès à un utilisateur pour un PC spécifié<br><br>
     * 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Nom du servlet
        String servletName = "AddUserToPC";
        ...
        if(token == null | login == null){
            ...
            if(token.equals("") | login.equals("")){
                ...
                if(access.equals("true")){
                    ...
                    DAO2.addUserToPC(idPC, login, TestBoolean);
