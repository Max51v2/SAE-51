...
public class ListUsers extends HttpServlet {
    ...
    /**
     * Liste les utilisateurs dans la BD<br><br>
     * 
     ...
     * String erreur       &emsp;&emsp;        types d'erreur : pas de token (req) | accès refusé <br>
     * OU <br>
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(token == null){
            ...
            if(token.equals("")){
                ...
                access = DAO.getServletRights("ListUsers", rights, false);
        ...
        if(access.equals("false")){    //note : on ne renvoi le champ "erreur que s'il y'en a une
